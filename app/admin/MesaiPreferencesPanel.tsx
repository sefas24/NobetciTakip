                ...
                >
                  <div className="flex justify-between items-start flex-wrap gap-2">
                    <div>
                      ...
                      {p.scheduleFileUrl && (
                        <a href={p.scheduleFileUrl} target="_blank" rel="noopener noreferrer" className="mt-2 text-xs text-blue-600 hover:text-blue-800 font-medium underline flex items-center gap-1">
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-gray-600 mt-1">
                      ...
                      {p.slots.filter((s: string) => !p.dutySlots.includes(s)).join(", ") || "-"}
                    </p>
                    ...
                    {p.imageUrl && (
                      <div className="mt-2 space-y-1">
                        {p.imageUrl.split(",").map((url, i, arr) => (
